 ...
 */
package pub.zilla.adapter.util;
...
import pub.zilla.adapter.ZillaAdapter;
...
//            }
            ...
            //ImageView
                ...
                try {
                    ImageView img = (ImageView) field.get(holder);
            ...
            //ViewGroup,used for display,can be -1 gone, 0 invisible,1 visible
            else if (ViewGroup.class.isAssignableFrom(dataType)) {
                try {
